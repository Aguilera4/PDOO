...
public int menuGestionInmobiliaria(){ //ejemplo de men˙
 ...
 public int menuSalirCarcel(){
    ...
    this.mostrar("Elige metodo para salir de la carcel");
    Map<Integer, String> menuGI = new TreeMap();
    menuGI.put(0, "Pagar 200 euros"); 
    menuGI.put(1, "Tirar dado ( para salir debe obtener mas de un 5 )");
  ...
  public boolean elegirQuieroComprar(){
    ...
    this.mostrar("¿Quieres compar esta propiedad ( 0 = No , 1 = Si )?");
    Map<Integer, String> menuGI = new TreeMap();
    menuGI.put(0, "No"); 
    menuGI.put(1, "Si");
  
    int i =this.seleccionMenu(menuGI); // MÈtodo para controlar la elecciÛn correcta en el men˙ 
